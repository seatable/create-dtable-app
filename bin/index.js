...
const spinner = ora();
const gitUrl = 'git@github.com:seatable/seatable-app-template.git';
...
program
  ...
  .action((name) => {
    ...
    process1.exec('git clone ' + gitUrl + ' ' + './' + projectName, function(error, stdout, stderr) {
      ...
      execSync('git commit -m "Initialize project using create-dtable-app"', {stdio: 'ignore', cwd: context});
